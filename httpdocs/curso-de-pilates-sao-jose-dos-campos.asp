...
<html>
  <head>
    <title>Curso de Pilates São José dos Campos - The Pilates Fitness</title>
<meta name="description" content="Curso de Pilates São José dos Campos Completo Formando Novas Turmas Semanalmente - Melhor Curso de Pilates de São José dos Campos" />
        ...
        <div class="row">
          <div style="width:100%" class="col-md-9">
            <div class="content">
              ...
              <p align="left"><strong>The Pilates Fitness - M2G STUDIO PILATES São José dos Campos - SP</strong></p>
              <p align="left">Rua: Bem Te Vi , 94 (Próximo ao Conj. Das Américas e Hipermercado Makro) – Vila Tabetuba</p>
              <p align="left">Tels:(11) 3297-2335/(11) 96781-1979</p>
            </div>
          </div>
        </div>
      </div>
