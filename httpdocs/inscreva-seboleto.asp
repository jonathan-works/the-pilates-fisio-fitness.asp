        ...
        <div class="row">
          <div class="col-sm-12 col-md-offset-3 col-md-6">
            <div class="thumbnail info-thumbnail background-lead color-text">
              ...
              <div class="caption bordered background-white" style="height: 470px;">
                <form name="form_insc" id="form_insc" method="post" action="https://www.thepilatesfisiofitness.com.br/email_inscrevase.asp" onSubmit="return checa ('document.form_insc')">
                  ...
                  <div class="controls controls-row">
                   ...
                   <div><input type="text" class="form-control input-lg" name="txt1_Cep" id="txt1_Cep" style="width:245px; margin-bottom:20px" placeholder="CEP"></div>
					...
					<div style="float:left"><input type="text" class="form-control input-lg" name="txt1_Estado" id="txt1_Estado" maxlength="2" style="position: absolute; width:245px; margin-right:20px; margin-bottom:20px" placeholder="Estado"></div>
...
<%end if%>    
                  ...
                  <input type="submit" class="btn btn-large btn-primary" name="submit" value="Enviar Inscrição" style="position: absolute; top: 450px; left: 200px;">
                  </div>
