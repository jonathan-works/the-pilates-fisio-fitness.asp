...
<script type="text/javascript">
  ...
  <body class="background-clouds">
	...
	sql_turma = "SELECT * FROM turma t INNER JOIN studio s ON t.cod_studio = s.cod_studio INNER JOIN uf u ON s.cod_uf = u.cod_uf INNER JOIN cidade ci ON replace(replace(replace(replace(replace(replace(replace(lower(s.cidade),'á','a'),'é','e'),'í','i'),'ó','o'),'ú','u'),'ã','a'),' ','') = ci.url WHERE disponivel = 0 and ci.url = '"&Lcase(cidade)&"' order by cod_turma DESC"
    ...
    <section class="">
      ...
      <div class="container">
        ...
        <h1><span>Curso de Pilates em Patologias em <%=rs_turma("cidade")%>  das 8:00 às 18:00hrs</span><br>
        </h1>
          ...
          <div style="width:50%" class="col-md-9">
            <div class="content">
              ...
              <p align="left">Rua: Nome da Rua, XX – Bairro</p>
               <p><span class="fa fa-phone-square color-lead"></span>(11) 4032-4568 |  (11) 98916.6173 | <img style="display:inline" src="whatsicon.jpg" width="16" height="16"  alt=""/> (11) 96781-1979</p>
              <p>&nbsp;</p>
            </div>
          </div>
          <div style="width:50%" class="col-md-9">
            ...
            <div class="info-thumbnail-link"> <br>
              <div class="thumbnail info-thumbnail popular background-background-clouds color-text">
                <div style="background-color:#CCC" class="special background-midnight-blue color-white">
                  <h5 style="color:#555555; size:10px"><strong>Valor: R$900,00. </strong>Ou em até</h5>
                </div>
                <div class="pricing-head">
                  <div class="pricing-head-body background-peter-river">
                    <div class="price-wrapper color-white"> <span class="price"><sup><small>10x R$</small></sup>90,<small>00</small></span><br>
                      <span class="per">no cartão</span> de crédito via Pagseguro.</div>
                  </div>
                </div>
                <div class="special background-midnight-blue color-white">
                  <h5>Desconto  para pagamento a vista por Depósito ou Boleto: <font color="#FFCC00">R$800,00</font>*<br>
                ...
                <div style="height:160px" class="caption bordered background-white">
                  <div   class="description">
                    <ul class="pricing-list">
                      <li>No cheque em até 10x R$90,00
                        
                    </ul>
                    <p>Curso de Pilates em Patologias</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div style="background-color:#f5f5f5"  class="caption bordered background-white">
                  <div class="description">
                    <p><strong> * PARA PAGAMENTOS COM BOLETO BANCÁRIO COM  DESCONTO:</strong> <br>
                      * Promoção válida por apenas 3 dias após geração do boleto. Após essa data, o desconto concedido no boleto cairá para  R$800,00 <br>
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div style="background-color:#f5f5f5"  class="caption bordered background-white">
                  <div class="description">
                    <p><strong> PARA PAGAMENTOS À PRAZO EM CHEQUE:</strong><br>
                      Gerar um boleto no valor de R$94,00 para pagamento da primeira parcela e o valor restante deve ser pago em até 10 cheques que devem ser levados no primeiro dia de aula.</p>
                  </div>
                </div>
              </div>
            </div>
  ...
  <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
    <div class="panel panel-default">
      ...
      <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne" aria-expanded="false" style="height: 0px;">
        <div class="panel-body"><strong>- 20 horas </strong>– Teórico e prático<br>
Um final de semana (sábado e domingo) ou durante a semana à confirmar.<br>
<em>*Seguindo os padrões de ensino do MEC onde a hora/aula é representada por 45  minutos.</em></div>
      </div>
    </div>
    ...
    <div class="panel panel-default">
      ...
      <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne" aria-expanded="false" style="height: 0px;">
        <div class="panel-body">- Camiseta e ou meias da escola<br>
          - Bolsa da escola com lápis <br>
          - Apostila com fotos coloridas e  o que tem de mais novo no mundo da reabilitação. <br>
** sorteio de viagens  e equipamentos.<br>
        </div>
      </div>
    </div>
...
<br>
- Certificado de conclusão de curso impresso com carga horaria de 20 h.  <br>
- Certificado serve para complemento de horas extracurriculares, obrigatório para obtenção de diploma de graduação.  <br>
- Metodologia aplicada e reconhecida mundialmente, além de referências como USP, UNIFESP, SANTA CASA. </div>
      </div>
    </div>
    <div class="panel panel-default">
      <div class="panel-heading" role="tab" id="headingFour">
        <h4 class="panel-title"> <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFour" aria-expanded="false" aria-controls="collapseFour"> CONTEÚDO PROGRAMÁTICO (CURSO DE PILATES EM PATOLOGIAS): </a> </h4>
      </div>
      <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour" aria-expanded="false">
        <div class="panel-body"><strong>I  –</strong> HISTÓRIA DO MÉTODO PILATES E SEU CRIADOR;<br>
          ...
          <strong>III  – </strong>PRINCIPIOS DO MÉTODO (CONCENTRAÇÃO, CENTRALIZAÇÃO (POWERHOUSE), RESPIRAÇÃO,  FLUIDEZ DOS MOVIMENTOS, PRECISÃO E CONTROLE);<br>
          ...
          <strong>VIII  –</strong> PATOLOGIAS ORTOPÉDICAS MÓDULO I –COLUNA E OMBRO (COLUNA - <br>
  ANATOMIA E BIOMECÂNICA, LOMBALGIAS, ESCOLIOSE,  HIPERCIFOSE, HIPERLORDOSE, HÉRNIA DISCAL, ESPONDILOLISTESE, DOR  CIÁTICA/CIATALGIA, ARTROSE/ARTRITE DE COLUNA. OMBRO - ANATOMIA E BIOMECÂNICA,  DISCINESE ESCAPULAR X DISCINESIA, SÍNDROME DO IMPACTO, INSTABILIDADE  MULTIDIRECIONAL, LUXAÇÃO DE OMBRO, LESÃO CABO LONGO DO BÍCEPS,        ARTROSE/ARTRITE DE OMBRO).<br>
  <strong>  IX -</strong> PATOLOGIAS ORTOPÉDICAS MÓDULO II – QUADRIL E JOELHO (QUADRIL - ANATOMIA E  BIOMECÂNICA, PUBALGIAS, TENDINITES, BURSITES   E ARTROSE DE QUADRIL, IMPACTO FÊMORO-ACETABULAR, LESÃO DE LABRUM (DOENÇA  DO GUGA – TENISTA), ARTROSES DA ARTICULAÇÃO SACRO-ILÍACA, &nbsp;ARTROSES DA  SÍNFISE PÚBICA. JOELHO – ANATOMIA E BIOMECANICA, DISFUNÇÃO FEMURO-PATELAR,  INSTABILIDADE PATELAR, LESÃO DO  LIGAMENTO CRUZADO ANTERIOR (LCA), LESÃO DO LIGAMENTO CRUZADO POSTERIOR (LCP),  LESÃO DE LIGAMENTOS COLATERAIS (LCM / LCL), LESÕES TRAUMÁTICAS DOS MENISCOS. <br>
  <strong>X  –</strong> REABILITAÇÃO ATRAVÉS DO PILATES;<br>
  <strong>XI  –</strong> INDICAÇÃO E CONTRAINDICAÇÃO DE CADA EXERCICIO PROPOSTO;<br>
  <strong>XII  –</strong> PRESCRIÇÃO DOS EXERCICIOS;<br>
  <strong>XIII  –</strong> DINÂMICA DE AULAS;<br>
  <strong>XIV  –</strong> AVALIAÇÃO E TESTES ORTOPÉDICOS; XIV – PRÁTICA (EXERCÍCIOS  DE SOLO, CADILLAC, REFOMER, STEP CHAIR, BARREL, ACESSÓRIOS E BOLA – TODOS OS  EXERCÍCIOS DE NÍVEIS INICIANTES/ INTERMEDIÁRIOS/ AVANÇADOS);</div>
      </div>
    </div>
...
- Formação em Pilates na Gravidez (korper); Formação alongamento consciente (Inélia Garcia); Formação em Pilates em Patologias (The Pilates Fisio Fitness); Formação Pilates on the Ball (Collen Craig Canadá); Formação em Pilates: Treinamento Avançado na Atuação do Instrutor (Silvia Gomes).<br>
...
<br>
    ...
    <section class="background-belize-hole color-white">
      <div class="container">
        <h1><span>Curso de Pilates em Patologias</span></h1>
        <div class="news"> <a class="news-link" href="">
          <div class="media clearfix background-belize-hole color-white">
            <div class="pull-left"> <img class="media-object" src="img/pato1.jpg" alt="..."> </div>
            ...
            <div class="media clearfix background-belize-hole color-white">
              <div class="pull-left"> <img class="media-object" src="img/pato2.jpg" alt="..."> </div>
              <div class="media-body">
              ...
              <div class="media clearfix background-belize-hole color-white">
                ...
                <div class="media-body">
                  ...
                  <p>E pague seu curso no cartão em até 10x R$90,00 ou a vista por R$800,00</p>
                </div>
              </div>
            </a> </div>
      </div>
