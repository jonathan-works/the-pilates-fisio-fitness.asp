...
<head>
    ...
    <td background="images/05.jpg"><font size="5" color="#FFFFFF" face="Arial, Helvetica, sans-serif"><b>Cursos</b></font></td>
		...
		<table border = "0" cellspacing = "1" cellpadding = "0" align = "center" width="600" class = "tabela">
		  <%
		  strSql2 = "Select * From inscricao where status = 'A' ORDER BY email"
		  ...
		  <tr>
					<td class = "linha1"> 
				<a href = "inc_inscricao.asp?acao=3&codigo=<%=objReg("Cod_Inscricao")%>">
					<%=objReg("email")%>
				</a>
			</td>
		  </tr>
...
<%
Else
	 Response.Redirect("inc_inscricao.asp?acao=1")
End If
Desconecta()
%>
