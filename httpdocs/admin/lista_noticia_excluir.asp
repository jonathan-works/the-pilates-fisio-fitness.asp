...
<%
		  ...
		  %>  
        <tr> 
          <td bgcolor="#ffffff"  onmouseover="bgColor='#f5f5f5'" onMouseOut="bgColor='FFffff'" class = "linha1" ><font color="#FF0000"><strong><a href="inc_Noticia.asp?acao=3&codigo=<%=rsNoticia("Cod_Noticia")%>">
		  <%
		  if rsNoticia("noticia_inter") = 1 then response.Write("<strong>NI</strong> - ")
		  %>
		  <%= rsNoticia("cod_Noticia") & " - " & rsNoticia("Titulo") %></a></strong></font>	
          <td bgcolor="#ffffff"  onmouseover="bgColor='#f5f5f5'" onMouseOut="bgColor='FFffff'" class = "linha1" ><font color="#FF0000"><strong><a href="inc_Noticia.asp?acao=2&codigo=<%=rsNoticia("Cod_Noticia")%>"></a></strong></font>
          
            <font color="#FF0000"><strong><a href="inc_Noticia.asp?acao=2&codigo=<%=rsNoticia("Cod_Noticia")%>"><%= rsNoticia("nome") %></a></strong></font>          </tr>
		<%
		     rsNoticia.MoveNext
		Loop
		%>
