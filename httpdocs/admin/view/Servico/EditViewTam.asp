                            	...
                            	<div class="col-lg-8">
                                	<select class="form-control" name="cod_tamanhoVeiculo" id="cod_tamanhoVeiculo">
                                		<%Do while not tamanhoVeiculos.eof%>
                                    		<option <%if tamanhoVeiculos("Cod_TamanhoVeiculo") = servicoTamanhoVeiculos("Cod_TamanhoVeiculo") Then Response.Write("selected")%> value="<%= tamanhoVeiculos("Cod_TamanhoVeiculo")%>"><%= tamanhoVeiculos("Descricao")%></option>
                            	...
                            	<div class="col-lg-8">
                                	<select class="form-control" name="cod_Servico" id="cod_Servico">
                                		<%Do while not servicos.eof%>
                                    		<option <%if servicos("Cod_Servico") = servicoTamanhoVeiculos("Cod_Servico") Then Response.Write("selected")%> value="<%= servicos("Cod_Servico")%>"><%= trim(servicos("Descricao"))%></option>
		                                <%servicos.movenext
        		                        Loop%>                                               
                                	</select>  
	                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                     <input type="text" maxlength="13" class="form-control" name="valor" id="valor"
                                           ...
                                           value="<%= formatnumber(servicoTamanhoVeiculos("Valor"),2)%>"/>
                                </div>
                            </div>
                             <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                     <input type="text" class="form-control" name="duracao" id="duracao"
                                           ...
                                           value="<%= servicoTamanhoVeiculos("Duracao")%>"/>
