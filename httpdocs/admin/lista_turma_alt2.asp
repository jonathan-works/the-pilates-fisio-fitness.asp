...
<head>
    ...
    <td background="images/05.jpg"><font size="5" color="#FFFFFF" face="Arial, Helvetica, sans-serif"><b>Cursos</b></font></td>
          ...
          <tr>
            ...
            <td>          
		<table border = "0" cellspacing = "1" cellpadding = "0" align = "center" width="646" class = "tabela">
		  <%
			Dim cidade
			...
			strSql4 = "Select distinct cidade FROM curso order by cidade"
			set objReg4 = cn.execute(strSql4)
			Do while not objReg4.Eof
			%>
                      <tr>
          <a href = "lista_turma_alt2.asp?cidade=<%=objReg4("cidade")%>"><%=objReg4("cidade")%></a>
          </tr>
		  ...
		  strSql2 = "Select t.*, c.curso as desc_curso, c.cidade as cidade_curso From turma t, curso c WHERE t.cod_curso = c.cod_curso and data like '%2014%' and c.cidade like '%"&cidade&"%' order by cod_turma desc"
