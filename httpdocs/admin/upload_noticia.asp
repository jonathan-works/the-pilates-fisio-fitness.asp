...
Set myFileUpload = Server.CreateObject("Persits.Upload")
' Capture files
myFileUpload.Save '"D:\http\vhosts\thepilatesfisiofitness.com.br\httpdocs\images\"
' Obtain file object
Set File = myFileUpload.Files("file2")
If Not File Is Nothing Then
	...
	For Each File in myFileUpload.Files
	File.SaveAs "D:\http\vhosts\thepilatesfisiofitness.com.br\httpdocs\images\noticia\p_"&codigo&arquivonome
	'response.Write("D:\http\vhosts\thepilatesfisiofitness.com.br\httpdocs\images\noticia\p_"&codigo&arquivonome)
	'response.End()
  ...
  ' Save to database
	...
	'strsql="INSERT INTO Imagem (cod_noticia,imagem) VALUES ("&codigo&",'"&codigo&arquivonome&"')"
	strsql = "update Noticia set imagem = 'p_"&codigo&arquivonome&"' where Cod_Noticia = "&codigo&""
...
End If
	...
	response.Redirect("Imagem_Noticia.asp?codigo="&codigo&"&upload=	s")
