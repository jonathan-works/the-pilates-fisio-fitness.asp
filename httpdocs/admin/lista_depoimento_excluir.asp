...
<table bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" width="80%" align="left">
	  ...
	  %>
        <tr> 
          <td bgcolor="#ffffff" class = "linha1"  onmouseover="bgColor='#f5f5f5'" onMouseOut="bgColor='FFffff'" ><font color="#FF0000"><strong><a href="inc_depoimento.asp?acao=3&codigo=<%=rsdepoimento("Cod_depoimento")%>"></a></strong></font>            <font color="#FF0000"><strong><a href="inc_depoimento.asp?acao=3&codigo=<%=rsdepoimento("Cod_depoimento")%>"><%= rsdepoimento("fonte") %> - <%= rsdepoimento("data") %></a></strong></font>                  
	  <%
