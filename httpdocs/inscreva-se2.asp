          ...
          <div class="col-sm-12 col-md-offset-3 col-md-6">
            <div class="thumbnail info-thumbnail background-lead color-text">
              ...
              <div class="caption bordered background-white">
                <form name="form_insc" id="form_insc" method="post" action="https://www.thepilatesfisiofitness.com.br/email_inscrevase2.asp" onSubmit="return checa ('document.form_insc')">
...
<%end if%>    
                  ...
                  <input type="submit" class="btn btn-large btn-primary" name="submit" value="Enviar Inscrição">
                  </div>
