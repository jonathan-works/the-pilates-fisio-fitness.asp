...
<html>
  ...
  <body class="background-clouds">
      ...
      <nav id="mainMenu" class="navbar navbar-fixed-top" role="navigation">
        <div class="container">
          ...
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html"><img src="img/logo.png" alt="logo">Neat</a>
          </div>
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a href="index-other.html">Home - other elements</a></li>
                </ul>
              </li>
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a href="entry-list.html">List of entries</a></li>
    ...
    <!-- Component: services/services.html - START -->
    <section class="">
      <div class="container">
        <h1><span>Notícias</span></h1>
        <div class="row">
          <div class="col-sm-4 col-md-4"> <a class="info-thumbnail-link" href="#">
            <div class="thumbnail info-thumbnail background-clouds color-text"> <img src="img/placeholder-annency-rect.jpg" alt="...">
              <div class="special background-peter-river color-white">
          ...
          <div class="col-sm-4 col-md-4">
            ...
            <div class="thumbnail info-thumbnail background-clouds color-text">
              <img src="img/placeholder-annency-rect.jpg" alt="...">
              <div class="special background-peter-river color-white"><h3>Some title here</h3></div>
              <div class="caption bordered background-white">
                <p class="description">You can use template elements as you have them in the examples but if you feel creative you can compose our own color combinations in ui elements. You have beutiful set of flat ui colors to work with just use <i>color-{color-name}</i> or <i>background-{color-name}</i> to change text color or background of any element on the page.</p>
              </div>
            </div>
    ...
    <!-- Component: services/services.html - END -->
