    ...
    <div class="breadcrumbs-container">
      <div class="container">
        <ol class="breadcrumb">
          ...
          <li class="active">Cursos em São Paulo</li>
        </ol>
      </div>
    </div>
    <section class="">
      <div class="container">
        <h1><span>Cursos em São Paulo</span></h1>
        <div class="row">
              ...
              <div class="thumbnail info-thumbnail  background-clouds color-text">
                <div class="pricing-head">
                  <div class="pricing-head-body background-peter-river">
                    <div class="price-wrapper color-white"> <span class="price"><sup><small>Turma </small></sup>32</span><br>
                   </div>
                  </div>
                </div>
                <div class="special background-midnight-blue color-white">
                  <h3>Início 18/06/2015</h3>
                </div>
                <div class="caption bordered background-white">
                  <div class="description" style="height:90px">
                    <p><strong>Final de Semana</strong></p>
                    <p>Dias 18, 19, 20 e 21 de Junho de 2015</p>
                   
                  </div>
                  <p ><a href="inscrevase.html" style="background-color:#090; width:140px" class="btn btn-lead btn-lg pull-right">Inscreva-se</a></p>
                </div>
              </div>
            </div>
          </div>
