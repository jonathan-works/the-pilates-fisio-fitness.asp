...
function lz_group(_id,_amount,_description,_email,_document,_cihidden,_cimandatory,_tihidden,_timandatory,_cinf,_coffinf,_cmbinf,_tinf,_tosc,_tost,_cf){
    this.Id = _id;
    this.Amount = _amount;
...
function lz_group_list(_document,_selectBox){
    ...
    function lz_group_list_add(_id,_amount,_description,_email,_cihidden,_cimandatory,_tihidden,_timandatory,_cinf,_coffinf,_cmbinf,_tinf,_tosc,_tost,_cf)
    {
        var existing = false;
        var currentGroup;
        var lastGroup;
        ...
        if(!existing)
        {
            currentGroup = new lz_group(_id,_amount,_description,_email,this.ActiveDocument,_cihidden,_cimandatory,_tihidden,_timandatory,_cinf,_coffinf,_cmbinf,_tinf,_tosc,_tost,_cf);
