...
function ServerInstallClass() {
    ...
    this.m_Data = {username:'administrator',firstname:'',lastname:'',email:'',password:'',setCookies:true,cookieLifetime:100,maskIP:true,maskIPFormat:1,respectDNT:false,dbExtension:'mysqli',dbEngine:'MyISAM',dbHost:'localhost',dbUser:'root',dbPassword:'',dbName:'',dbPrefix:'lz_'};
}
