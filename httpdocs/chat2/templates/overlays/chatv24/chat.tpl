<div id="lz_chat_overlay_pointer_h" class="lz_chat_overlay_pointer" style="display:none;border-top:12px solid transparent; border-left: 12px solid #ccc;border-bottom: 12px solid transparent;">
...
<div id="lz_chat_overlay_pointer_v" class="lz_chat_overlay_pointer" style="border-left:12px solid transparent; border-top: 12px solid #ccc;border-right: 12px solid transparent;">
...
<div id="lz_chat_overlay_main" class="lz_chat_base notranslate" style="direction:<!--dir-->;border-radius:<!--brt-->px <!--brt-->px <!--brb-->px <!--brb-->px;background: linear-gradient(180deg, <!--pc--> 50px, #fff 51px, #fff 100%);" onclick="lz_chat_switch_options_table(true);">
    ...
    <div id="lz_chat_content">
		...
		<div id="lz_overlay_module_chat" class="lz_chat_module">
            ...
            <div id="lz_chat_overlay_bottom">
                ...
                <div>
                    <textarea id="lz_chat_text" placeholder="<!--lang_client_type_message-->" onchange="lz_overlay_chat_impose_max_length(this, <!--overlay_input_max_length-->);" onkeyup="lz_overlay_chat_impose_max_length(this, <!--overlay_input_max_length-->);OverlayChatWidgetV2.InputKeyUp(event);"></textarea>
                </div>
            </div>
