...
define("TEMPLATE_SCRIPT_TRACK",PATH_TEMPLATES . "jscriptv24/jstrack.tpl");
define("TEMPLATE_SCRIPT_CONNECTOR",PATH_TEMPLATES . "jscriptv24/jsconnector.tpl");
define("TEMPLATE_SCRIPT_GROUPS",PATH_TEMPLATES . "jscriptv24/jsgroups.tpl");
define("TEMPLATE_SCRIPT_GLOBAL",PATH_TEMPLATES . "jscriptv24/jsglobal.js");
define("TEMPLATE_SCRIPT_INVITATION",PATH_TEMPLATES . "invitations/");

define("TEMPLATE_SCRIPT_OVERLAY_CHAT",PATH_TEMPLATES . "overlays/chatv24/");
define("TEMPLATE_HTML_MESSAGE_OVERLAY_CHAT_STATUS",PATH_TEMPLATES . "overlays/chatv24/messagestatus.tpl");
define("TEMPLATE_HTML_MESSAGE_OVERLAY_CHAT_PICTURE",PATH_TEMPLATES . "overlays/chatv24/messagepicture.tpl");
