...
class DatabaseMaintenance
{
    static function Optimize()
    {
        ...
        $year = max(2015,date("Y")-1);
        $rand = rand(0,13);

        if($rand == 13)
        {
            DBManager::Execute(true, "DELETE FROM `" . DB_PREFIX . DATABASE_STATS_AGGS_BROWSERS . "` WHERE `year` < " . intval($year));
            DBManager::Execute(true, "DELETE FROM `" . DB_PREFIX . DATABASE_STATS_AGGS_RESOLUTIONS . "` WHERE `year` < " . intval($year));
            DBManager::Execute(true, "DELETE FROM `" . DB_PREFIX . DATABASE_STATS_AGGS_COUNTRIES . "` WHERE `year` < " . intval($year));
            DBManager::Execute(true, "DELETE FROM `" . DB_PREFIX . DATABASE_STATS_AGGS_VISITS . "` WHERE `year` < " . intval($year));
        }
        else if($rand == 12)
        {
            DBManager::Execute(true, "DELETE FROM `" . DB_PREFIX . DATABASE_STATS_AGGS_SYSTEMS . "` WHERE `year` < " . intval($year));
            DBManager::Execute(true, "DELETE FROM `" . DB_PREFIX . DATABASE_STATS_AGGS_LANGUAGES . "` WHERE `year` < " . intval($year));
            DBManager::Execute(true, "DELETE FROM `" . DB_PREFIX . DATABASE_STATS_AGGS_CITIES . "` WHERE `year` < " . intval($year));
            DBManager::Execute(true, "DELETE FROM `" . DB_PREFIX . DATABASE_STATS_AGGS_REGIONS . "` WHERE `year` < " . intval($year));
            DBManager::Execute(true, "DELETE FROM `" . DB_PREFIX . DATABASE_STATS_AGGS_ISPS . "` WHERE `year` < " . intval($year));
        }
        else if($rand == 11)
        {
            DBManager::Execute(true, "DELETE FROM `" . DB_PREFIX . DATABASE_STATS_AGGS_QUERIES . "` WHERE `year` < " . intval($year));
            DBManager::Execute(true, "DELETE FROM `" . DB_PREFIX . DATABASE_STATS_AGGS_PAGES . "` WHERE `year` < " . intval($year));
            DBManager::Execute(true, "DELETE FROM `" . DB_PREFIX . DATABASE_STATS_AGGS_DOMAINS . "` WHERE `year` < " . intval($year));
            DBManager::Execute(true, "DELETE FROM `" . DB_PREFIX . DATABASE_STATS_AGGS_REFERRERS . "` WHERE `year` < " . intval($year));
            DBManager::Execute(true, "DELETE FROM `" . DB_PREFIX . DATABASE_STATS_AGGS_AVAILABILITIES . "` WHERE `year` < " . intval($year));
            DBManager::Execute(true, "DELETE FROM `" . DB_PREFIX . DATABASE_STATS_AGGS_FEEDBACKS . "` WHERE `year` < " . intval($year));
        }
        else if($rand == 10)
        {
            DBManager::Execute(true, "DELETE FROM `" . DB_PREFIX . DATABASE_STATS_AGGS_DURATIONS . "` WHERE `year` < " . intval($year));
            DBManager::Execute(true, "DELETE FROM `" . DB_PREFIX . DATABASE_STATS_AGGS_CHATS . "` WHERE `year` < " . intval($year));
            DBManager::Execute(true, "DELETE FROM `" . DB_PREFIX . DATABASE_STATS_AGGS_TICKETS . "` WHERE `year` < " . intval($year));
            DBManager::Execute(true, "DELETE FROM `" . DB_PREFIX . DATABASE_STATS_AGGS_SEARCH_ENGINES . "` WHERE `year` < " . intval($year));
            DBManager::Execute(true, "DELETE FROM `" . DB_PREFIX . DATABASE_STATS_AGGS_VISITORS . "` WHERE `year` < " . intval($year));
            DBManager::Execute(true, "DELETE FROM `" . DB_PREFIX . DATABASE_STATS_AGGS_CRAWLERS . "` WHERE `year` < " . intval($year));
        }
        else if($rand == 9)
        {
            DBManager::Execute(true, "DELETE FROM `" . DB_PREFIX . DATABASE_STATS_AGGS_PAGES_ENTRANCE . "` WHERE `year` < " . intval($year));
            DBManager::Execute(true, "DELETE FROM `" . DB_PREFIX . DATABASE_STATS_AGGS_PAGES_EXIT . "` WHERE `year` < " . intval($year));
            DBManager::Execute(true, "DELETE FROM `" . DB_PREFIX . DATABASE_STATS_AGGS_GOALS . "` WHERE `year` < " . intval($year));
            DBManager::Execute(true, "DELETE FROM `" . DB_PREFIX . DATABASE_STATS_AGGS_GOALS_QUERIES . "` WHERE `year` < " . intval($year));
            DBManager::Execute(true, "DELETE FROM `" . DB_PREFIX . DATABASE_STATS_AGGS_KNOWLEDGEBASE . "` WHERE `year` < " . intval($year));
        }
        else if($rand == 8)
        {
