...
FeedbacksViewer.prototype.CreateFeedbacksHtml = function(_list,_elementId){
    ...
    var bodyString = '<table class="visible-list-table alternating-rows-table lzm-unselectable" id="feedbacks-table'+_elementId+'"><thead><tr>' +
        '<th></th>'+
    ...
    bodyString += '</tr></thead><tbody>' + this.GetFeedbackLines(_list,_elementId) + '</tbody></table>';
...
FeedbacksViewer.RemoveFeedback = function(){
    if(lzm_commonPermissions.permissions.delete_feedbacks != 1)
    {
