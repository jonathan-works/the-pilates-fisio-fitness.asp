...
LinkGeneratorClass.prototype.ShowLinkGeneratorCode = function(){
    ...
    if(this.isTypeSelected('inlay-text')||this.isTypeSelected('inlay-image')||this.isTypeSelected('overlay-button-v1')){
    ...
    this.m_Settings = [
        {name:'General', title: t('General'), groups: [
            {name: 'Protocol', title: tid('protocol'), controls: [
                {name:'m_ProtocolHTTP', type:'radio', group: 'prot-select', value: true, title: 'HTTP&nbsp;&nbsp;<span class="bg-red text-white text-box">' + tid('no_mixed_mode') + '</span>', static: true},
