  ...
  <body class="background-clouds">
    ...
    <div class="breadcrumbs-container">
      <div class="container">
        <ol class="breadcrumb">
          ...
          <li class="active">Cursos em <%if not rs_turma.eof then response.write(rs_turma("cidade")) else response.write("nenhuma turma disponível")%></li>
    ...
    <section class="">
      ...
      <div class="container">
        ...
        <h1><span>Curso de Pilates Completo em <%=rs_turma("cidade")%>  das 8:00 às 18:00hrs</span><br>
        </h1>
		<%else%>
		<h1><span>Nenhuma turma disponível</span><br>
        </h1>		
		<%end if%>
          ...
          <div class="col-sm-6 col-md-3">
            <div class="info-thumbnail-link"> <br>
              <div class="thumbnail info-thumbnail popular background-background-clouds color-text">
                ...
                <div class="special background-midnight-blue color-white">
                  <h5>Desconto  para pagamento a vista por Depósito ou Boleto: <font color="#FFCC00">R$1610,00</font>*<br>
                ...
                <div style="height:160px" class="caption bordered background-white">
                  <div   class="description">
                    <ul class="pricing-list">
                      <li>No cheque em até 10x R$189,00
