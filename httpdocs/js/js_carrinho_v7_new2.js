...
function isValidCreditCardNumber(cardNumber, cardType){
    ...
    switch(cardType){
        ...
        default:
            prefixRegExp = /^$/;
            //alert("Por favor selecione a bandeira.");
    }
...
{	
	...
	// criacao do objeto XMLHTTP do arquivo ajax.js
     ...
     oHTTPRequest.open("post", "../cielo/pages/carrinhoCartaoPagamento2.php", true); //enviamos para a pÃ¡gina que faz o select do que foi digitado e traz a lista preenchida.
   ...
   // a funcao abaixo e executada sempre que o estado do objeto muda (onreadystatechange)
     oHTTPRequest.onreadystatechange=function()
	 {
			 ...
			 if (oHTTPRequest.status == 200) 
	  		 {
				...
				//alert(retorno_compra);
				 ...
				 if ((retorno_compra == 4) || (retorno_compra == 6) )
				 {
						...
						location.href="http://www.thepilatesfisiofitness.com.br/compra-concluida.asp?id="+id;
		...
		{	
			...
			oHTTPRequest.send("id=" + encodeURI(id) + "&numero_cartao=" + encodeURI(numero_cartao) + "&nome_cartao=" + encodeURI(nome_cartao) + "&parcela=" + encodeURI(parcela) + "&mes_cartao=" + encodeURI(mes_cartao) + "&ano_cartao=" + encodeURI(ano_cartao) + "&codigo_cartao=" + encodeURI(codigo_cartao) + "&forma_pagamento=" + encodeURI(forma_pagamento) + "&valor_curso=" + encodeURI(valor_curso));
