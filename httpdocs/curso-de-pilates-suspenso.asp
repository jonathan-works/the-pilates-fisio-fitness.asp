  ...
  <body class="background-clouds">
    ...
    <section class="">
      ...
      <div class="container">
        ...
        <h1><span>Curso de Pilates Suspenso (Aéreo) em <%=rs_turma("cidade")%>  das 8:00 às 18:00hrs</span><br>
        </h1>
                ...
                <div style="height:160px" class="caption bordered background-white">
                  <div   class="description">
                    <ul class="pricing-list">
                      <li>No cheque em até 10x R$94,00
                        
                    </ul>
                    <p>Curso de Pilates Suspenso (Aéreo)</p>
                  </div>
                </div>
              </div>
            </div>
    ...
    <div class="panel panel-default">
      ...
      <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne" aria-expanded="false" style="height: 0px;">
        <div class="panel-body">
          <p>- Camiseta e ou meias da escola<br>
            - Bolsa da escola com lápis <br>
            - Apostila com fotos coloridas<br>
            - O que tem de mais novo no mundo da reabilitação. <br>
...
- Metodologia aplicada e reconhecida mundialmente, além de referências como USP, UNIFESP, SANTA CASA. </div>
    ...
    <div class="panel panel-default">
      <div class="panel-heading" role="tab" id="headingFour">
        <h4 class="panel-title"> <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFour" aria-expanded="false" aria-controls="collapseFour"> CONTEÚDO PROGRAMÁTICO (CURSO DE PILATES SUSPENSO): </a> </h4>
      </div>
      <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour" aria-expanded="false">
        <div class="panel-body"><strong>I  </strong> – HISTÓRIA DO MÉTODO PILATES E SEU CRIADOR;<br>
            ...
            <strong>IV</strong> – PILATES DE BASE/ PRÉ PILATES;<br>
            <strong>V </strong>- CONSEQUÊNCIAS DOS DESIQUILÍBRIOS MUSCULARES;<br>
            <strong>VI -</strong>  INTRODUÇÃO AO PILATES SUSPENSO;<br>
            <strong>VII</strong> -  BENEFICIOS; <br>
            <strong>VIII</strong> –  INDICAÇÃO E CONTRAINDICAÇÔES ABSOLUTAS  E RELATIVAS;<br>
            <strong>IX</strong> – PROGRAMAÇÃO DE AULAS – INTENSIDADE, CARGA, REPETIÇÕES;<br>
            <strong>X</strong> – EVOLUÇÃO DO ALUNO NOS EXERCICIOS;<br>
            <strong>XI</strong> - INDICAÇÃO E PRESCRIÇÃO DE CADA EXERCICIO PROPOSTO;<br>
            <strong>X</strong> – EQUIPAMENTOS (CADILLAC, TRX – FITA DE SUSPENSÃO E COLUMPIO (TECIDO SUSPENSO);<br>
            <strong>XI</strong> – FIXAÇÃO, ESPAÇO FISICO, MONTAGEM E DICAS DOS EQUIPAMENTOS;<br>
            <strong>XII</strong> - DINÂMICA DE AULAS;<br>
            <strong>XIII</strong> – PRÁTICA (EXERCÍCIOS DE SOLO, CADILLAC, COLUMPIO E TRX – TODOS OS EXERCÍCIOS  DE NÍVEIS INICIANTES/ INTERMEDIÁRIOS/ AVANÇADOS); <br>
            <strong>XIV</strong> – PRÁTICA  SUPERVISIONADA<br>
      </div>
      </div>
    </div>
...
<br>
    ...
    <section class="background-belize-hole color-white">
      <div class="container">
        <h1><span>Curso de Pilates Suspenso (Aéreo)</span> </h1>
        <div class="news"> <a class="news-link" href="">
          <div class="media clearfix background-belize-hole color-white">
            <div class="pull-left"> <img class="media-object" src="img/suspenso1.jpg" alt="..."> </div>
            <div class="media-body">
              <h3 class="media-heading">• Conheça nossos Aparelhos abaixo:</h3>
            </div>
          </div>
          </a> <a class="news-link" href="">
            <div class="media clearfix background-belize-hole color-white">
              <div class="pull-left"> <img class="media-object" src="img/suspenso2.jpg" alt="..."> </div>
              <div class="media-body">
                <h3 class="media-heading">• CADILLAC, TRX - FITA DE SUSPENSÃO E COLUMPIO (TECIDO SUSPENSO</h3>
