  ...
  <body class="background-clouds">
    ...
    <section class="">
      ...
      <div class="container">
        ...
        <h1><span>Curso de Pilates na Gestação em <%=rs_turma("cidade")%>  das 8:00 às 18:00hrs</span><br>
        </h1>
            ...
            <div class="info-thumbnail-link"> <br>
              <div class="thumbnail info-thumbnail popular background-background-clouds color-text">
                <div style="background-color:#CCC" class="special background-midnight-blue color-white">
                  <h5 style="color:#555555; size:10px"><strong>Valor: R$600,00. </strong>Ou em até</h5>
                </div>
                <div class="pricing-head">
                  <div class="pricing-head-body background-peter-river">
                    <div class="price-wrapper color-white"> <span class="price"><sup><small>10x R$</small></sup>60,<small>00</small></span><br>
                      <span class="per">no cartão</span> de crédito via Pagseguro.</div>
                  </div>
                </div>
                <div class="special background-midnight-blue color-white">
                  <h5>Desconto  para pagamento a vista por Depósito ou Boleto: <font color="#FFCC00">R$500,00</font>*<br>
                ...
                <div style="height:160px" class="caption bordered background-white">
                  <div   class="description">
                    <ul class="pricing-list">
                      <li>No cheque em até 10x R$64,00
                        
                    </ul>
                    <p>Curso de Pilates na Gestação</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div style="background-color:#f5f5f5"  class="caption bordered background-white">
                  <div class="description">
                    <p><strong> * PARA PAGAMENTOS COM BOLETO BANCÁRIO COM  DESCONTO:</strong> <br>
                      * Promoção válida por apenas 3 dias após geração do boleto. Após essa data, o desconto concedido no boleto cairá para  R$500,00 <br>
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div style="background-color:#f5f5f5"  class="caption bordered background-white">
                  <div class="description">
                    <p><strong> PARA PAGAMENTOS À PRAZO EM CHEQUE:</strong><br>
                      Gerar um boleto no valor de R$64,00 para pagamento da primeira parcela e o valor restante deve ser pago em até 10 cheques que devem ser levados no primeiro dia de aula.</p>
                  </div>
                </div>
              </div>
            </div>
...
- Metodologia aplicada e reconhecida mundialmente, além de referências como USP, UNIFESP, SANTA CASA. </div>
    ...
    <div class="panel panel-default">
      <div class="panel-heading" role="tab" id="headingFour">
        <h4 class="panel-title"> <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFour" aria-expanded="false" aria-controls="collapseFour"> CONTEÚDO PROGRAMÁTICO (CURSO DE PILATES NA GESTAÇÃO): </a> </h4>
      </div>
      <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour" aria-expanded="false">
        <div class="panel-body"><strong>I  </strong> – HISTÓRIA DO MÉTODO PILATES E SEU CRIADOR;<br>
            ...
            <strong>            IV </strong>–  GRAVIDEZ E ATIVIDADE FÍSICA, <br>
            <strong>V </strong>- GUIDELINES (OBSTETRÍCIA E GINECOLOGIA)<br>
            <strong>VI </strong>– INDICAÇÕES, CONTRA INDICAÇÕES ABSOLUTAS, CONTRA INDICAÇÕES RELATIVAS;<br>
            <strong>VII </strong>- CONDIÇÕES ESPECIAIS DURANTE A GESTAÇÃO - PRÉ-ECLÂMPSIA, DIABETES GESTACIONAL, 
            HIPERTENSÃO GESTACIONAL, OBESIDADE, LOMBALGIAS;<br>
            <strong>VIII</strong> – PRESCRIÇÃO DE EXERCÍCIOS, INTENSIDADE, FREQUÊNCIA, DURAÇÃO;<br>
            <strong>IX </strong>– PREPARAÇÃO E CUIDADOS;<br>
            <strong>X</strong> – INDICAÇÃO DE EXERCÍCIOS POR TRIMESTRE GESTACIONAL;<br>
            <strong>XI</strong> – FICHA DE AVALIAÇÃO;<br>
            <strong>XII</strong> – AVALIAÇÃO TEÓRICA E PRÁTICA;<br>
            <strong>XIII</strong> – PRÁTICA (EXERCÍCIOS DE SOLO, CADILLAC, REFOMER, STEP CHAIR, BARREL, ACESSÓRIOS E BOLA – TODOS OS EXERCÍCIOS DE NÍVEIS INICIANTES/ INTERMEDIÁRIOS/ AVANÇADOS);<br>
...
<br>
    ...
    <section class="background-belize-hole color-white">
      <div class="container">
        <h1><span>Curso de Pilates na Gestação</span></h1>
        <div class="news"> <a class="news-link" href="">
          <div class="media clearfix background-belize-hole color-white">
            <div class="pull-left"> <img class="media-object" src="img/gestante1.jpg" alt="..."> </div>
            ...
            <div class="media clearfix background-belize-hole color-white">
              <div class="pull-left"> <img class="media-object" src="img/gestante2.jpg" alt="..."> </div>
              <div class="media-body">
              ...
              <div class="media clearfix background-belize-hole color-white">
                ...
                <div class="media-body">
                  ...
                  <p>E pague seu curso no cartão em até 10x R$60,00 ou a vista por R$500,00</p>
                </div>
              </div>
            </a> </div>
      </div>
