    ...
    static function GetObjectFields($_objName)
    {
        ...
        if($_objName=="Ticket")
            return array(
                ...
                "Channel"=>array("Input"=>true,"Output"=>true,"Type"=>"int","Description"=>"Channel<br><br>[0] = Web<br>[1] = Email<br>[2] = Phone<br>[3] = Misc<br>[4] = Chat<br>[5] = Rating","Required"=>false,"Example"=>"0, added in LiveZilla 6.1.0.0; replaces <i>CreationType</i> available in previous versions.","MultilineDescription"=>true),
                "SubChannel"=>array("Input"=>true,"Output"=>true,"Type"=>"string","Description"=>"Sub-Channel Name","Required"=>false,"Example"=>"Sub Channel Name, added in LiveZilla 6.1.0.0","MultilineDescription"=>false),
        ...
        if($_objName=="TicketEditor")
            return array(
                ...
                "SubStatus"=>array("Input"=>true,"Output"=>true,"Type"=>"string","Description"=>"Ticket Sub-Status","Required"=>false,"Example"=>"Sub-Status Name, added in LiveZilla 6.1.0.0","MultilineDescription"=>false),
