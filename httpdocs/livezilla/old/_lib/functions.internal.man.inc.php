        ...
        if(OperatorRequest::IsValidated() && Is::Defined("VALIDATED_FULL_LOGIN") && OperatorRequest::IsAdministrator(true))
        {
            ...
            while(isset($_POST["p_operators_" . $count . "_id"]))
            {
                ...
                else
                {
                    ...
                    if(!isset($_POST["p_operators_" . $count . "_ldap"]))
                        $_POST["p_operators_" . $count . "_ldap"] = (!empty(Server::$Operators[$_POST["p_operators_" . $count . "_system_id"]])) ? Server::$Operators[$_POST["p_operators_" . $count . "_system_id"]]->LDAP : false;
